(function () {
    const applyTableStyles = () => {
        ...
        if (table) {
            table.classList.add("w-full", "border-collapse", "border", "border-gray-300", "text-left", "text-sm");

            // Apply classes to table header
            const thead = table.querySelector("thead");
            if (thead) {
                thead.classList.add("bg-gray-200");
                thead.querySelectorAll("th").forEach(th => {
                    th.classList.add("border", "border-gray-300", "px-4", "py-2", "font-semibold", "text-gray-700");
                });
            }

            // Apply classes to table body
    ...
    applyTableStyles(); // Execute immediately
})();
(function ($) {
    "use strict";
